[Konstruct.bricks 2.3.2](http://konstruct.github.io)
=============

**konstruct.bricks** are a set of common objects that can be dropped into your site. They are based on good practise code and years of past experience.

### Current objects:

- **Buttons** various button layouts.
- **Messages** various utility/system message formats.
